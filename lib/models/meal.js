...
class Meal {
  ...
  static deleteFoodFromMeal(mealID, foodID) {
    ...
    return database.raw('DELETE FROM meals_foods WHERE meal_id = ? AND food_id = ?', [mealID, foodID])
  }

  static createMeal(foodID, mealID) {
    return database.raw('INSERT INTO meals_foods (food_id, meal_id) VALUES (?, ?)', [foodID, mealID])
  }
}
